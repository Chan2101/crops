...
osr_data = pd.read_excel('data/mean-time-series-osr-national-data-september-2024-1.xlsx', header=1)
wheat_data = pd.read_excel('data/mean-time-series-wheat-national-data-september-2024-2.xlsx', header=1)
weather_data = pd.read_csv('data/uk_daily_weather_by_region.csv', parse_dates=['date'])  # change path if needed
